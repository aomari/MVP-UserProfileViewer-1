...
import com.amjadomari.mvpuserprofile.di.component.ActivityComponent;
import com.amjadomari.mvpuserprofile.di.component.DaggerActivityComponent;
...
public abstract class BaseActivity extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActivityComponent = DaggerActivityComponent.builder()
                ...
                .applicationComponent(((UserProfileApplication) getApplication()).getComponent())
                .build();
